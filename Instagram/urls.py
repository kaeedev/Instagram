...
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) #Esto ultimo es para que nos funcione y nos cargue los archivos media como fotos. Debemos importar settings y static
